...
class CenturyOldTunesApp {
    ...
    async loadRecordings() {
        ...
        console.log('loadRecordings() started');
        ...
        try {
            console.log('About to call loadDataFromAPI()');
            
            // Load real data from JSON files generated by R export script
            await this.loadDataFromAPI();
            
            console.log('loadDataFromAPI() completed, recordings count:', this.recordings.length);
            
            // Apply filters and render
            console.log('About to apply filters and render');
            this.applyFiltersAndRender();
            
            console.log('applyFiltersAndRender() completed');
            ...
            console.log('loadRecordings() finally block, hiding loading');
    ...
    async loadDataFromAPI() {
        try {
            console.log('Starting to load data from recordings.json...');
            ...
            console.log('Raw recordings loaded:', this.recordings.length, 'records');
            console.log('First raw record:', this.recordings[0]);
            ...
            console.log('Processed recordings:', this.recordings.length, 'records');
            console.log('First processed record:', this.recordings[0]);
